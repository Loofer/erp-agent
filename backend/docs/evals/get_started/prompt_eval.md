# Ragas - Evaluate a prompt Tutorial
> Page: Evaluate a prompt - Ragas
> URL: https://docs.ragas.io/en/stable/tutorials/prompt/
...
> 💡 Quick Start: If you want to see the complete evaluation in action, you can jump straight to the [Running the example end to end](#running-the-example-end-to-end) section that runs everything and generates the CSV results automatically.
...
run_experiment.arun(dataset, "gpt-5.6-terra")

# Or use keyword arguments
run_experiment.arun(dataset, model="gpt-5.6-terra")
```
