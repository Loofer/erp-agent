# Ragas Section
Page: LangGraph‑Ragas
URL: https://docs.ragas.io/en/stable/howtos/integrations/_langgraph_agent_evaluation/
...
- Build a [ReAct agent](https://arxiv.org/abs/2210.03629) to fetch metal prices.
- Set up an evaluation pipeline to track key performance metrics.
- Run and assess the agent's effectiveness with different queries.
...
To convert a list of LangChain messages into a format suitable for Ragas evaluation, Ragas provides the function [`convert_to_ragas_messages`](https://docs.ragas.io/en/stable/references/integrations/#ragas.integrations.langgraph.convert_to_ragas_messages), which can be used to transform LangChain messages into the format expected by Ragas.
